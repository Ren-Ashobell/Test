...
$('.waifu-tool .fui-info-circle').click(function (){
    window.open('https://www.cnblogs.com/xiaolubin/p/13049758.html');
});
...
function waifuWelcome(){
    var text;
    var SiteIndexUrl = 'https://www.cnblogs.com/xiaolubin/';  // 手动指定主页
